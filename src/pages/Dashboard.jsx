...
const Dashboard = () => {
  ...
  return (
   <>
  <div className='main flex w-full h-full bg-[#0E2241]'>
<div  className='sidenav w-[10%]'>
<div className="text-white">
      <div
        className="text-2xl p-3 cursor-pointer"
        onClick={() => setIsOpen(prev => !prev)}
      >
    <span>{isOpen ? <IoMdClose /> : <HiMenu/>
}</span>
      </div>
      ...
      {isOpen && (
        <div className="h-screen  flex flex-col gap-4 p-3">
          ...
          <div
            ...
            className={`cursor-pointer p-2 rounded flex gap-2 items-center ${active === "analytics" ? "bg-[#006CFE] font-medium" : ""}`}
          >
            <IoIosAnalytics />
            <h3>Analytics</h3>
          </div>
...
<div className='border w-[80%] mt-5'>
